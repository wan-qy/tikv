...
pub fn flush_engine_ticker_metrics(t: TickerType, value: u64) {
    match t {
        ...
        TickerType::BlockCacheByteRead => {
            STORE_ENGINE_FLOW_VEC.with_label_values(&["block_cache_byte_read"])
                .set(value as f64);
        }
        TickerType::BlockCacheByteWrite => {
            STORE_ENGINE_FLOW_VEC.with_label_values(&["block_cache_byte_write"])
                .set(value as f64);
        }
        TickerType::BloomFilterUseful => {
        ...
        TickerType::NoIterators => {
            STORE_ENGINE_NO_ITERATOR.set(value as f64);
        }
        TickerType::BloomFilterPrefixChecked => {
...
lazy_static!{
    ...
    pub static ref STORE_ENGINE_NO_ITERATOR: Gauge =
        register_gauge!(
